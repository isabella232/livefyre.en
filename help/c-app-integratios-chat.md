...
title: Chat
uuid: bdea0a0d-8dcf-4937-8306-e0a34b94db48
index: y
internal: n
snippet: y
---
...
Embedding the Chat App follows the process for embedding a Core App described in Getting Started > [Embedding an App](c-implementation-process/c-using-livefyre.js-to-create-customize-and-use-apps-on-your-site.md#c_using_livefyre.js_to_create_customize_and_use_apps_on_your_site)
...
As noted in the [CollectionMeta Token](c-implementation-process/c-collectionmeta-tokent.md#c_collectionmeta_tokent) section, CollectionMeta is an encoded JSON object. In the above example, the JSON object takes the following format before its JWT encoded:
...
<table frame="all" rowsep="1" colsep="1" id="table_adq_qy5_nz"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> String (required) </td> 
   <td> JWT-encoded metadata about the Collection. See <a href="c-implementation-process/c-collectionmeta-tokent.md#c_collectionmeta_tokent" format="dita" scope="local"> CollectionMeta Object </a> for more information. </td> 
  </tr> 
  <tr> 
...
For more information, and for a list of available events, see Reference > [Javascript Events](c-javascript-events.md#c_javascript_events). 
