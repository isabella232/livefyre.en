...
uuid: b3662453-37c9-459a-831e-b55e1a6359c0
index: y
internal: n
snippet: y
translate: y
...
![](images/strings_newestoldesttop-1-150x56.png) 
...
![](images/strings_threadend-150x47.png) 
...
|---|---|---|
|  **Featured labels** | | |
|   ![](images/strings_featuredcontent-150x40.png)  | featuredCommentsTag  | Featured  |
...
|---|---|---|
|  **Editor buttons** | | |
|   ![](images/strings_texteditor-1-150x77.png)  | follow  | + Follow  |
|  | unfollow  | - Unfollow  |
...
|   ![](images/strings_banusermodal-150x36.png)  | flagButton  | Flag  |
...
|  **Flag Modal** | | |
|   ![](images/strings_responseoptions-150x35.png)  | flagTitle  | Flag %s’s comment  |
...
|  **Share Modal** | | |
|   ![](images/strings_flagmodal-150x87.png)  | shareTitle  | Share Comment  |
...
|  **Reply Modal** | | |
|   ![](images/strings_sharemodal-150x59.png)  | postReplyAsButton  | Post comment as…  |
|  | postReplyButton(Available for logged in users.)  | Post comment  |
|  | backToHotThreads  | Back to Hot Threads  |
|   ![](images/strings_replymodal-150x64.png)  | backToComments(Appears above reply modal for featured content.)  | Back to Newest  |
|  **Twitter @mention modal** | | |
|   ![](images/strings_backto-150x48.png)  | mentionTitle  | Share Mention  |
...
|   ![](images/strings_sharemention-150x60.png)  | @(@mention.)  | |
...
|   ![](images/strings_moderatoreditmodal-150x49.png)  | pendingComment  | pending  |
...
|   ![](images/strings_adminoptions-150x33.png)  | banTitle  | Ban User  |
...
|---|---|---|
|  **Notifier labels** | | |
|   ![](images/strings_notifier-150x112.png)  | commentNotifier  | New Comment  |
