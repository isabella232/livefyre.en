...
>## Sidenotes Text Strings {#c_sidenotes_text_strings}Customizing the text strings for Livefyre Sidenotes<!-- c_sidenotes_text_strings.dita --> This page lists and describes all strings available for customization in Sidenotes apps. For information on strings available for the core Livefyre apps, please see String Customizations.
