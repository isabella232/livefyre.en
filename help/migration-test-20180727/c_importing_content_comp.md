...
<!-- c_importing_existing_data.dita --> Livefyre enables customers to import legacy comment and user profile data, allowing you to maintain user history in your new Livefyre App.
...
```
>## Importing Content {#c_importing_content}Importing user and comment data into Livefyre.<!-- c_importing_content.dita --> Import legacy content after your user profile data import is complete to allow Livefyre to link content to its author appropriately.
...
```
>## Importing Ratings and Reviews {#c_importing_ratings_and_reviews}Importing ratings and reviews data to Livefyre.<!-- c_importing_ratings_and_reviews.dita --> Importing your legacy ratings and reviews data allows you to maintain historic data in your Livefyre Ratings and Reviews Apps.
