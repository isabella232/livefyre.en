...
uuid: 05c28f02-92ba-4135-a8ee-0ecf55e89943
index: y
internal: n
snippet: y
translate: y
...
1. Change hostnames from `{*}.<network>.fyre.co` to `<network>.{*}.fyre.co`. For example, the host name `example.network.fyre.co` changes to `network.example.fyre.co`.
