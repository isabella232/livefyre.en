...
* [](#c_permalinks)
<!-- c_content_collection_tags.dita --> Assigning tags allows you to filter searches by a specific tag, and to pull data for the Heat Index API.
...
* [Trending](c_trending_app.md#c_trending_app)
* [Upload Button](c_upload_button_app.md#c_upload_button_app)
>## Filter Search by Collection or Content tag {#t_filter_search_by_tag}Filter content searches in Studio by Collection tag.<!-- c_content_collection_tags.dita --> 
...
>    * Featured (Head)
>    
>## Select Content to Feature from an App {#t_select_content_to_feature}Feature or unfeature content directly from an App/<!-- t_select_content_to_feature.dita --> 
...
>## Select Content to Feature From Studio {#select_content_to_feature_from_studio}You can select content to feature from Studio instead of an App.<!-- t_select_content_to_feature_from_studio.dita --> 
...
</uicontrol> setting in Studio.<!-- t_enable_featuring_content_in_studio.dita --> 
...
>## Permalinks {#c_permalinks}Use your bit.ly URL shortener to customize content permalinks.<!-- c_permalinks.dita --> Permalinks allow you to link to archived comments or content within your streams. To enable this feature, Livefyre uses a default URL format: **fyre.it**. This format may be customized to match your standard bit.ly format.
