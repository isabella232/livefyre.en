...
<!-- c_content_behavior_features.dita --> 
...
* [ Chat ](c_chat_app.md#c_chat_app)
* [ Comments ](c_comments_app.md#c_comments_app)
>## Photo Upload {#c_photo_upload}Upload images to a Live Blog, Chat, Reviews, or Comments stream.<!-- c_photo_upload.dita --> Photos may be uploaded directly into any App from a user’s mobile photo library, computer hard drive, or social network accounts.
...
>## Upload Photos {#t_upload_photos}Photos may be uploaded directly into any App from a user’s mobile photo library, computer hard drive, or social network accounts.<!-- t_upload_photos.dita --> 
