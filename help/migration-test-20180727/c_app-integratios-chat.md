...
title: Chat
uuid: b7ad8f17-1f98-4d9f-809b-e00e6cad6235
index: y
internal: n
snippet: y
translate: y
...
## Chat {#topic_0304CCA49D974949BC8A33D3142A1FFE}Adding live chat to your page.
...
>## Integration {#concept_0A99792A7E89403F95D082D52D600F17}Embedding the Chat App follows the process for embedding a Core App described in Getting Started &gt; [ Embedding an App ](c_using_livefyre.js_to_create_customize_and_use_apps_on_your_site.md#c_using_livefyre.js_to_create_customize_and_use_apps_on_your_site) 
Example:
...
As noted in the [ CollectionMeta Token ](c_collectionmeta_tokent.md#c_collectionmeta_tokent) section, CollectionMeta is an encoded JSON object. In the above example, the JSON object takes the following format before its JWT encoded: 
...
<table frame="all" rowsep="1" colsep="1" id="table_adq_qy5_nz"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> String (required) </td> 
   <td> JWT-encoded metadata about the Collection. See <a href="c_collectionmeta_tokent.dita#c_collectionmeta_tokent" format="dita" scope="local"> CollectionMeta Object </a> for more information. </td> 
  </tr> 
  <tr> 
...
>## CollectionMeta Object {#c_collectionmeta_object}The 
<codeph>
  CollectionMeta 
...
>## Adding an Event Handler {#concept_E7C17EFB43F24F1A8572E60C69176C6D}To register event handlers, use the widget.on call within the App's callback function.
For example:
