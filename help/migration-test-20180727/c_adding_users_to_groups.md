...
uuid: 6c26ec2c-3612-4e5a-a9c9-bd3cb7bb9b37
index: y
internal: n
snippet: y
translate: y
...
* Click ** `Add Group` ** or the group label below any username to open the groups menu.
* Scroll through the list and find the group to which you wish to add the user. You can enter a group name in the ** `Search` ** box at the top of the dropdown.
