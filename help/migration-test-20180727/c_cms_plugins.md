...
<!-- c_livefyre_for_wordpress.dita --> The Livefyre WordPress Enterprise plugin allows you to add Livefyre Comments, Chat, Live Blog, or Sidenotes to your WordPress site.
...
>## Embed a Livefyre App Inside a Wordpress Page or Post {#t_embed_a_livefyre_app_inside_a_wordpress_page_or_post}<!-- t_embed_a_livefyre_app_inside_a_wordpress_page_or_post.dita --> 
...
>## Install Livefyre for WordPress {#t_install_livefyre_for_wordpress}<!-- t_install_livefyre_for_wordpress.dita --> 
...
>## Troubleshooting: Visualization Apps in WordPress Shortcode {#c_troubleshooting_visualization_apps_in_wordpress_shortcode}<!-- c_troubleshooting_visualization_apps_in_wordpress_shortcode.dita --> 
|  **Problem** | **Solution** |
|---|---|
